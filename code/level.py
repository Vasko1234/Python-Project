...
from settings import tile_size, SCREEN_HEIGHT, SCREEN_WIDTH, graphics
        ...
        for row_index, row in enumerate(layout):
            for col_index, value in enumerate(row):
                if value != "-1":
                    ...
                    if type == "terrain":
                        terrain_tile_list = import_cut_graphics(f"Python-Project/{graphics}/terrain/terrain_tiles.png")
                        tile_surface = terrain_tile_list[int(value)]
                        sprite = StaticTile(tile_size, x, y, tile_surface)

                    if type == "grass":
                        grass_tile_list = import_cut_graphics(f"Python-Project/{graphics}/decoration/grass/grass.png")
                    ...
                    if type == "coins":
                        if value == "0":
                            sprite = Coin(tile_size, x, y, f"Python-Project/{graphics}/coins/gold")
                        if value == "1":
                            sprite = Coin(tile_size, x, y, f"Python-Project/{graphics}/coins/silver")

                    if type == "fg_palms":
                        if value == "0":
                            sprite = Palm(tile_size, x, y, f"Python-Project/{graphics}/terrain/palm_small", 38)
                        if value == "1":
                            sprite = Palm(tile_size, x, y, f"Python-Project/{graphics}/terrain/palm_large", 64)

                    if type == "bg_palms":
                        sprite = Palm(tile_size, x, y, f"Python-Project/{graphics}/terrain/palm_bg", 64)
    ...
    def player_setup(self, layout):
        for row_index, row in enumerate(layout):
            for col_index, value in enumerate(row):
                ...
                if value == "1":
                    hat_surface = pygame.image.load(f"Python-Project/{graphics}/character/hat.png").convert_alpha()
