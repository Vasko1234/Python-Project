...
class Player(pygame.sprite.Sprite):
    def __init__(self, position, surface, create_jump_particles, change_health):
        ...
        self.jump_sound = pygame.mixer.Sound("Python-Project/audio/effects/jump.wav")
        self.jump_sound.set_volume(0.5)
        self.hit_sound = pygame.mixer.Sound("Python-Project/audio/effects/hit.wav")
    ...
    def run_dust_animation(self):
        if self.status == "run" and self.on_ground:
            ...
            if self.facing_right:
                position = self.rect.bottomleft - pygame.math.Vector2(7, 11)
                self.display_surface.blit(dust_particle, position)
            else:
                position = self.rect.bottomright - pygame.math.Vector2(7, 11)
